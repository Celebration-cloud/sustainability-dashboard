...
const SustainableDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:3000/api/mockData");
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <option value="cs">Carbon Emissions</option>
        ...
        {/* Charts Grid */}
        <DashboardCharts darkMode={darkMode} filteredData={filteredData} selectedMetric={selectedMetric}/>
      </div>
    </div>
  );
};
