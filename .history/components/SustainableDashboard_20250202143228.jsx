...
import { LineChart, BarChart, PieChart, ResponsiveContainer, Line, Bar, Pie, CartesianGrid, XAxis, YAxis, Tooltip, Legend } from 'recharts';
import { SunIcon, MoonIcon, CalendarIcon, FilterIcon } from '@heroicons/react/24/outline';
...
const Dashboard = () => {
  ...
  const filteredData = data.filter(item => {
    ...
    return (!dateRange.start || itemDate >= new Date(dateRange.start)) &&
